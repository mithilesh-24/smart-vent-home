      ...
      <div className="container page">
        <div className="products-head">
          ...
          <div className="products-toolbar">
            ...
            <button className="btn btn-outline products-filter-btn" onClick={() => setShowFilters((s) => !s)}>Filters</button>
          </div>
        </div>

        <div className="products-layout">
          <aside className={`products-sidebar ${showFilters ? "open" : ""}`}>{Filters}</aside>
          {filtered.length === 0 ? (
            <div className="products-empty"><p>No products match your filters.</p></div>
          ) : (

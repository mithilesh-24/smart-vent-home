      ...
      <div className="container page">
        ...
        <div className="cart-layout">
            ...
            {detailed.map(({ item, product }) => (
              <div key={product.id} className="cart-item">
                ...
                <div className="cart-item-info">
                  <Link to={`/products/${product.id}`} className="cart-item-title">{product.name}</Link>
          ...
          <aside className="cart-summary">
            ...
            <button className="btn btn-cta btn-lg btn-block mt-4" onClick={handleCheckout}>Proceed to Checkout</button>
            {!isAuthenticated && (

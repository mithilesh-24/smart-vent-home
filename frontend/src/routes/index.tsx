...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "SmartVent — Smart Ventilation for Modern Homes" },
      { name: "description", content: "IoT-powered ventilation: smart fans, sensors and controllers with an integrated air-quality dashboard." },
    ],
  }),
  component: Home,
});

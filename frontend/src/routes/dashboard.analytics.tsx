...
import { roomAqi as fallbackRoomAqi, timeSeries as fallbackTimeSeries } from "../data/dashboard";
import type { TimePoint } from "../data/dashboard";
...
function AnalyticsPage() {
  ...
  useEffect(() => {
    ...
    apiFetch<{ room: string; aqi: number }[]>("/device/room-aqi").then((res) => {
